...
import 'package:quote_app/Controller/Quotes/QuotesController.dart';
import 'package:quote_app/view/GenralScreen/Categroy.dart';

class GenralScreen extends StatelessWidget {
  const GenralScreen({super.key});
        ...
        itemBuilder: (context, index) {
          ...
          return GestureDetector(
            onTap: () {
              ...
              Get.to(() => CategoryScreen(category: category[index]));
            },
            child: Container(
