...
import 'package:quote_app/Controller/Quotes/ThemeController.dart';
import 'package:quote_app/utils/ThemeList.dart';
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            sectionTitle('Colors'),
            themePhoto(Photo, context, themeController),
            sectionTitle('Wallpaper'),
            themePhoto(Photo2, context, themeController),
            sectionTitle('Natural'),
            themePhoto(Photo3, context, themeController),
            sectionTitle('Themes'),
            themePhoto(Photo4, context, themeController),
          ],
        ),
      ),
    );
