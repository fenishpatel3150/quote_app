...
import 'package:quote_app/Helper/QuotesHelper.dart';
import 'package:quote_app/Model/QuoteModel.dart';
...
class QuotesController extends GetxController {
  ...
  void fetchQuotes() async {
    isLoading(true);
    try {
      final response = await http.get(Uri.parse('https://sheetdb.io/api/v1/ijalfqzzvwh0c'));
